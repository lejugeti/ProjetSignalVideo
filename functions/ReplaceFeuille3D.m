function [newFrame, X1, Y1] = ReplaceFeuille3D(frame, img, PGH, PGB, PDH, PDB, PB1, PB2)
...
h = Homographie3D(PGH, PGB, PDH, PDB, PB1, PB2, lengthX, lengthY); % matrice d'homographie 3x3
h = inv(h'*h) * h';
